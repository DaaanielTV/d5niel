...
const projects = [
	{
		...
		image: "https://images.unsplash.com/photo-1627856013091-fed6e4e30025?w=400&h=250&fit=crop&fm=webp&q=60"
	},
	{
		...
		image: "https://images.unsplash.com/photo-1563089145-599997674d42?w=400&h=250&fit=crop&fm=webp&q=60"
	}
];
							...
							<div className="p-6">
								...
								<div className="flex flex-wrap gap-2 mb-4">
									{project.tags.map((tag) => (
										<span key={tag} className="px-3 py-1 bg-black text-white rounded-full text-sm">
											{tag}
										</span>
									))}
								</div>
				...
				<div className="grid md:grid-cols-2 gap-8">
					{pastProjects.map((project) => (
						<div key={project.title} className="p-6 rounded-lg border border-gray-200 hover:border-gray-300">
							...
							<div className="flex flex-wrap gap-2 mb-4">
								{project.tags.map((tag) => (
									<span key={tag} className="px-3 py-1 bg-gray-900 text-white rounded-full text-sm">
										{tag}
									</span>
								))}
							</div>
